...
export const useSkillsStore = defineStore("skills", () => {
  const skills = ref([
...

    {
      ...
      skills: ["Figma", "CorelDRAW", "Inkscape", "Responsive UI Design"],
    },

    {
      category: "Data & Integration",
      skills: ["API Integration", "JSON Data Handling", "Data Visualization (Chart.js)"],
    },
...

    {
      ...
      skills: ["Communication", "Team Collaboration", "Problem Solving", "Critical Thinking"],
    },
  ]);
  return { skills };
});
