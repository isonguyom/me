<template>
  ...
  >
    <div
      :class="[
        'flex justify-between items-center w-full p-4 md:px-6 z-50',
            ...
            <button
              ...
              :class="[
                ...
                activeIndex === index
                  ...
                  : 'text-white border-white/0 hover:text-secondary',
              ]"
              role="button"
              tabindex="0"
...
// watch for every true occurrence of hideEl prop to animate the navbar
watch(
  () => props.hideEl,
  (newVal) => {
