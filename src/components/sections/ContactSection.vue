<template>
  <div
    ref="contactSection"
    class="h-full w-full flex justify-center items-center py-14 relative bg-primary bg-linear-to-br from-primary to-black/60 text-background"
    id="contact"
  >
    <!-- Top right pattern -->
    <div
      class="absolute top-0 right-0 flex justify-center items-center pointer-events-none w-37.5 lg:w-50"
    >
    ...
    <!-- Bottom Left pattern -->
    <div
      class="absolute bottom-0 left-0 flex justify-center items-center pointer-events-none w-37.5 lg:w-50"
    >
          ...
          <address class="not-italic text-white space-y-1">
            <p>
              ...
              <a
                ...
                class="opacity-80 hover:text-accent hover:opacity-100 transition-colors duration-300 allow-copy"
                >+2348022475918</a
              >
            </p>
            <p>
...
import MainToast from "@/components/utilities/MainToast.vue";
